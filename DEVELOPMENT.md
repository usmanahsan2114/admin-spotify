...
- **Storefront Implementation**: Built a complete public-facing storefront using React, Tailwind CSS, and the public API. Features include a responsive design, product browsing, cart management, and checkout validation.
